...
var MyList = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(MyList, [{
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<div>\n                        <h1>", "</h1>\n                        <ul>\n                        ", "\n                        </ul>\n                    </div>"])), this.title, this.lista !== undefined ? this.lista.map(function (el) {
        return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<li>", "</li>"])), el.name);
      }) : 'Cargando datos');
    }
  }], [{
    key: "properties",
...
var HellowWord = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HellowWord, [{
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<div>\n            <p>Message:", "</p>\n            <p>MessageOutside:", "</p>     \n            <p>Count:", "</p>   \n            <my-message message=\"Mensaje de prueba\"></my-message>\n            <my-list title=\"Mis peliculas favoritas\" lista=", "></my-list>\n        </div>"])), this.message, this.messageOutside, this.count, JSON.stringify(this.items));
    }
  }], [{
    key: "properties",
    get: function get() {
...
var MyApp = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(MyApp, [{
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<div>Hola mundo2</div>\n                    <hellow-word></hellow-word>\n        "])));
    }
  }]);
